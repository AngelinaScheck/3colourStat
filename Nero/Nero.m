...
function Nero()
    ...
    dataPopup ...
        = uicontrol(controlPanel, ...
                    'style', 'popup', ...
                    'string', 'Select option...|Create histograms|Time evolution|FRET per mol|Export current trace', ...
                    'enable', 'off',...                    
    ...
    %data for 3 colour experiment statistics
    filePopup ...
        = uicontrol(controlPanel, ...
                    'style', 'popup', ...
                    'string', 'Select option...|Import TwoTone file|Export ebFRET file|Load Nero session|Save Nero Session|Import tirfAnalysis file', ...
                    'enable', 'on',...                    
    ...
    function fretPerMolClick(source, callbackdata)
        if (isempty(NeroData.mols))
            msgbox('You need to load TwoTone traces before you can create signal histograms');
            return;
        end                  
